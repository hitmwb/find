...
public class RedisClientTemplate {
	private static final LogProxy LOGGER = new LogProxy(RedisClientTemplate.class);
	...
	public boolean setbit(String key, long offset, boolean value) {
		...
		try {
			result = jedis.setbit(key, offset, value).booleanValue();
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public boolean getbit(String key, long offset) {
		...
		try {
			result = jedis.getbit(key, offset).booleanValue();
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public long setrange(String key, long offset, String value) {
		...
		try {
			result = jedis.setrange(key, offset, value).longValue();
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public Long rpush(String key, String string) {
		...
		try {
			result = jedis.rpush(key, new String[] { string });
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public Long sadd(String key, String member) {
		...
		try {
			result = jedis.sadd(key, new String[] { member });
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public Long srem(String key, String member) {
		...
		try {
			result = jedis.srem(key, new String[] { member });
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public Long hdel(byte[] key, byte[] field) {
		...
		try {
			result = jedis.hdel(key, new byte[][] { field });
	...
	public Long rpush(byte[] key, byte[] string) {
		...
		try {
			result = jedis.rpush(key, new byte[][] { string });
	...
	public Long lpush(byte[] key, byte[] string) {
		...
		try {
			result = jedis.lpush(key, new byte[][] { string });
	...
	public Long sadd(byte[] key, byte[] member) {
		...
		try {
			result = jedis.sadd(key, new byte[][] { member });
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public Long srem(byte[] key, byte[] member) {
		...
		try {
			result = jedis.srem(key, new byte[][] { member });
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
	...
	public Long zrem(byte[] key, byte[] member) {
		...
		try {
			result = jedis.zrem(key, new byte[][] { member });
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			jedis.close();
